...
export default class Solar_Search extends Component {
    ...
    entrySubmit() {
        ...
        axios.post('http://localhost:3000/api/addEntry', obj).then((response) => {
    ...
    entryUpdate(id) {
        ...
        axios.put('http://localhost:3000/api/updateEntry', obj).then((response) => {
        this.setState({solarHappenings: response.data})
    ...
    entryDelete(id) {
        ...
        axios.delete('http://localhost:3000/api/deleteEntry', obj).then((response) => {
            this.setState({solarHappenings: response.data})
        })
    }
    ...
    //       axios.get('http://localhost:3000/api/display').then((response) => {
    //           this.setState({samplePost})
    //       })
    //   }
